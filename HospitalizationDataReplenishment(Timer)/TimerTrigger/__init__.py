...
connstr = 'BlobEndpoint=https://covidforecastingsa.blob.core.windows.net/;QueueEndpoint=https://covidforecastingsa.queue.core.windows.net/;FileEndpoint=https://covidforecastingsa.file.core.windows.net/;TableEndpoint=https://covidforecastingsa.table.core.windows.net/;SharedAccessSignature=sv=2020-08-04&ss=bfqt&srt=sco&sp=rwdlacupix&se=2022-12-10T00:06:56Z&st=2021-12-09T16:06:56Z&spr=https&sig=ONTuMmHuGik4Ra8nvCQp1Fm7NScMik2%2BdD2jpi4J1vk%3D'
...
def get_missing_dates(blob_client):
    ...
    return [dates.append(i.strftime("%Y-%m-%d")) for i in date_list]
